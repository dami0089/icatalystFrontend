...
import ListadoDeMaterias from "../components/materias/ListadoDeMaterias";
import ModalCrearMateria from "../components/materias/ModalCrearMateria";
import useMaterias from "../hooks/useMaterias";

export function Materias() {
	const { handleModalAgregarMateria, modalAgregarMateria } = useMaterias();
	...
	return (
		<div className="mt-12">
			<div className="mb-12 grid gap-x-6 gap-y-10 md:grid-cols-2 xl:grid-cols-4 ">
				<Card className="hover:cursor-pointer" onClick={handleAgregarMateria}>
					<Button
			...
			{modalAgregarMateria ? <ModalCrearMateria /> : ""}
			{/* {modalEditarProfesor ? <ModalEditarMateria /> : ""} */}
